...
> = {
    ...
    typescript: {
        ...
        colors: {
            ticket: 'bg-blue-300/50',
            border: 'border-blue-300',
            text: 'text-blue-200',
            month: 'text-blue-300',
            time: 'text-blue-400',
        },
        figure: '-right-32 -bottom-32',
    },
    html: {
        component: ({ className }) => (
    ...
    vue: {
        ...
        colors: {
            ...
            text: 'text-green-200',
            month: 'text-green-300',
            time: 'text-green-400',
        },
    },
    angular: {
        component: ({ className }) => (
            <svg width="100%" viewBox="0 0 256 272">
                <path
                    fill="#E23237"
    ...
    preact: {
        component: ({ className }) => (
            ...
            >
                <path
                    fill="#673AB8"
                    d="m128 0 128 73.9v147.8l-128 73.9L0 221.7V73.9z"
                />
                <path
        ...
        colors: {
            ticket: 'bg-[#673AB8]/50',
            border: 'border-[#673AB8]',
            text: 'text-purple-200',
            month: 'text-purple-200',
    ...
    nextjs: {
        ...
        figure: 'flex items-end mb-[50px] mr-[40px]',
    },
    nuxt: {
        component: ({ className }) => (
            <svg
    ...
    flutter: {
        component: ({ className }) => (
            <svg
                ...
                height="97%"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 35.064 43.413"
            >
                <path
                    d="m35.063,20.038h-13.357l-11.686,11.689,6.677,6.677,18.366-18.366Z"
                    fill="#54c5f8"
                />
                <path
                    d="m6.68,28.386L0,21.706,21.706,0h13.358L6.68,28.386Z"
                    fill="#54c5f8"
                />
                <path
                    d="m16.698,38.404l5.009,5.009h13.358l-11.689-11.686-6.677,6.677Z"
                    fill="#01579b"
                />
                <path
                    d="m16.698,38.404l9.906-3.429-3.229-3.248-6.677,6.677Z"
                    fill="none"
                />
                <path
                    d="m16.697,25.046l-6.678,6.677,6.678,6.678,6.677-6.678-6.677-6.677Z"
                    fill="#29b6f6"
                />
            </svg>
        ),
            ...
            >
                ...
                <g clipPath="url(#clippath)">
                    <g>
                        ...
                        />
                        <path
                            d="m32.03,28.76l-7-13.21-15.44,29.38,22.44-16.17Z"
                            fill="#f57c00"
                        />
                        <path
    ...
    php: {
        component: ({ className }) => (
            <svg className={className} viewBox="0 0 711.20123 383.5975">
                <defs id="defs3434">
            ...
            >
                ...
                <g>
                    <path
                        ...
                        fill="url(#linearGradientScala-1)"
                    ...
                    <path
                        ...
                        fill="url(#linearGradientScala-2)"
            ...
            <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    ...
                    >
                        ...
                        <stop stopColor="#CB417E" offset="8%" />
                        <stop stopColor="#9E4E9B" offset="16%" />
                        <stop stopColor="#755BB4" offset="25%" />
                        <stop stopColor="#5365CA" offset="34%" />
                        <stop stopColor="#386DDB" offset="44%" />
                        <stop stopColor="#2374E9" offset="54%" />
                        <stop stopColor="#1478F3" offset="66%" />
                    ...
                    >
                        <stop stopColor="#FE315D" offset="0%" />
                        <stop stopColor="#F63462" offset="4%" />
                        <stop stopColor="#DF3A71" offset="10%" />
                        <stop stopColor="#C24383" offset="17%" />
                        <stop stopColor="#AD4A91" offset="29%" />
                        <stop stopColor="#755BB4" offset="55%" />
                        <stop stopColor="#1D76ED" offset="92%" />
                        <stop stopColor="#087CFA" offset="100%" />
                    </linearGradient>
                </defs>
                <path
